...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _css_styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/styles.css */ \"./src/css/styles.css\");\n/* harmony import */ var _validate_display_invalid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validate.display-invalid */ \"./src/js/validate.display-invalid.js\");\n/* harmony import */ var _validate_display_valid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./validate.display-valid */ \"./src/js/validate.display-valid.js\");\n/* harmony import */ var _validate_user_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./validate.user-form */ \"./src/js/validate.user-form.js\");\n\n\n\n\n\nconst form = document.querySelector('form');\n\nform.onsubmit = (event) => {\n  event.preventDefault();\n  const data = new FormData(form);\n\n  form.childNodes.forEach((domElement) => {\n    const element = domElement;\n    if (element.nodeName === 'INPUT') {\n      if (element.value === '') {\n        element.classList.add('invalid');\n        element.nextElementSibling.style.visibility = 'visible';\n      }\n    }\n  });\n  const [email, , zip, password, passwordConfirmation] = data;\n  // VALIDATION\n  const emailInput = document.querySelector('#email');\n  const zipInput = document.querySelector('#zip');\n  const passwordInput = document.querySelector('#password');\n  const confirmationInput = document.querySelector('#confirmPassword');\n  if (!(0,_validate_user_form__WEBPACK_IMPORTED_MODULE_3__.validateEmail)(email[1])) {\n    (0,_validate_display_invalid__WEBPACK_IMPORTED_MODULE_1__.displayInvalid)(emailInput);\n  } else {\n    (0,_validate_display_valid__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(emailInput);\n  }\n\n  console.log(password[1], passwordConfirmation[1]);\n  if (!(0,_validate_user_form__WEBPACK_IMPORTED_MODULE_3__.validateZip)(zip[1])) {\n    (0,_validate_display_invalid__WEBPACK_IMPORTED_MODULE_1__.displayInvalid)(zipInput);\n  } else {\n    (0,_validate_display_valid__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(zipInput);\n  }\n  if (!(0,_validate_user_form__WEBPACK_IMPORTED_MODULE_3__.validatePassword)(password[1])) {\n    (0,_validate_display_invalid__WEBPACK_IMPORTED_MODULE_1__.displayInvalid)(passwordInput);\n    passwordInput.nextElementSibling.textContent = (0,_validate_display_invalid__WEBPACK_IMPORTED_MODULE_1__.displayInvalidPassword)(\n      // eslint-disable-next-line comma-dangle\n      password[1]\n    );\n  } else {\n    (0,_validate_display_valid__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(passwordInput);\n    passwordInput.nextElementSibling.textContent =\n      '1 UPPERCASE LETTER, 1 LOWERCASE LETTER, 1 SPECIAL CHARACTER, 1 NUMBER, MINIMUM 8 CHARACTERS & MAXIMUM 30 CHARACTERS*';\n  }\n  if (!(0,_validate_user_form__WEBPACK_IMPORTED_MODULE_3__.validatePasswordConfirmation)(password[1], passwordConfirmation[1])) {\n    (0,_validate_display_invalid__WEBPACK_IMPORTED_MODULE_1__.displayInvalid)(confirmationInput);\n  } else {\n    (0,_validate_display_valid__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(confirmationInput);\n  }\n};\n\n\n//# sourceURL=webpack://linting/./src/js/index.js?");
