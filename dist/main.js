...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _css_styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/styles.css */ \"./src/css/styles.css\");\n/* harmony import */ var _validate_user_form__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validate.user-form */ \"./src/js/validate.user-form.js\");\n\n\n\nconst form = document.querySelector('form');\n\nform.onsubmit = (event) => {\n  event.preventDefault();\n  const data = new FormData(form);\n\n  form.childNodes.forEach((element) => {\n    if (element.nodeName === 'INPUT') {\n      if (element.value === '') {\n        element.classList.add('invalid');\n      }\n    }\n  });\n  const [email, , zip, password, passwordConfirmation] = data;\n  // EMAIL VALIDATION\n  (0,_validate_user_form__WEBPACK_IMPORTED_MODULE_1__.validateEmail)(email[1]);\n  (0,_validate_user_form__WEBPACK_IMPORTED_MODULE_1__.validateZip)(zip[1]);\n  (0,_validate_user_form__WEBPACK_IMPORTED_MODULE_1__.validatePassword)(password[1]);\n  (0,_validate_user_form__WEBPACK_IMPORTED_MODULE_1__.validatePasswordConfirmation)(password[1], passwordConfirmation[1]);\n};\n\n\n//# sourceURL=webpack://linting/./src/js/index.js?");
